...
CartListResponse _$CartListResponseFromJson(Map<String, dynamic> json) => CartListResponse(
  valid:
...
Map<String, dynamic> _$CartListResponseToJson(CartListResponse instance) => <String, dynamic>{
  'valid': instance.valid,
  'invalid': instance.invalid,
  'deduction': instance.deduction,
};

CartDeduction _$CartDeductionFromJson(Map<String, dynamic> json) => CartDeduction(
  seckillId: json['seckill_id'] == null ? 0 : _numToInt(json['seckill_id']),
  bargainId: json['bargain_id'] == null ? 0 : _numToInt(json['bargain_id']),
  combinationId: json['combination_id'] == null ? 0 : _numToInt(json['combination_id']),
  discountId: json['discount_id'] == null ? 0 : _numToInt(json['discount_id']),
);

Map<String, dynamic> _$CartDeductionToJson(CartDeduction instance) => <String, dynamic>{
...
CartItem _$CartItemFromJson(Map<String, dynamic> json) => CartItem(
  ...
  attrStatus: json['attr_status'] == null ? false : _numToBool(json['attr_status']),
  vipTruePrice: json['vip_true_price'] == null ? 0 : _numToDouble(json['vip_true_price']),
...
ProductInfo _$ProductInfoFromJson(Map<String, dynamic> json) => ProductInfo(
  ...
  sliderImage: (json['slider_image'] as List<dynamic>?)?.map((e) => e as String).toList(),
...
ProductAttrInfo _$ProductAttrInfoFromJson(Map<String, dynamic> json) => ProductAttrInfo(
  id: json['id'] == null ? 0 : _numToInt(json['id']),
  productId: json['product_id'] == null ? 0 : _numToInt(json['product_id']),
...
Map<String, dynamic> _$ProductAttrInfoToJson(ProductAttrInfo instance) => <String, dynamic>{
  'id': instance.id,
  'product_id': instance.productId,
  'suk': instance.suk,
