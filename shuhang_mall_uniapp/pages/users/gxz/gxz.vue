<template>
	<view :style="colorStyle">
		<view class='commission-details'>
			<view class='promoterHeader m-2' style="height: 124px;">
				<view class='headerCon'>
					<view class="acea-row row-between-wrapper align-center" style="height: 100%;">
					<view>
						<view class='name'>燃料值</view>
						<view class='money'><text class='num'>{{gxz}}</text></view>
									
					</view>
					<image src="../../../static/images/gxb.png" mode="" style="width: 65rpx;height: 65rpx;"></image></view>
