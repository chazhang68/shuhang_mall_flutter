 ...
 * 手机号修改支付密码
 * **/
export function zhiFuRegisterReset(data) {
	return request.post('edit/pay_pwd', data, {
		noAuth: true
	})
}
...
export function getUserinfo_bank(){
 ...
 * 解绑银行卡
 * **/
export function getJiebang(){
	return request.get('jiebang', {},{
		noAuth: true
	})
}
