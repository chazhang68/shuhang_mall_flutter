...
export function xfqDui(data) {
	return request.post('xfq_dui',data, {
		noAuth: true
	});
}
export function get_hy_list(data) {
	return request.get('get_hy_list',data, {
		noAuth: true
	});
}
export function swpDui(data) {
	return request.post('swp_dui',data, {
		noAuth: true
	});
}
/**
...
export function registerVerify(data) {
	return request.post("register/easy_verify", data, {
		noAuth: true
	});
}
...
export function getUserTask() {
	return request.get("user/task_list", {}, {
		noAuth: true
	});
}
...
export function getFudouList(data) {
	return request.get('fudou/list',data)
}
export function getFubaoList(data) {
	return request.get('fubao/list',data)
}
export function getGxzList(data) {
	return request.get('gxz/list',data)
}
export function getRyzList(data) {
	return request.get('ryz/list',data)
}
/*
 * 消费券记录
 * */
...
export function exchangeTask(data) {
	return request.post('task/exchange_task',data)
}
export function getMyTask(data) {
	return request.get('task/my_task',data);
}
export function getNewMyTask() {
	return request.get('task/new_my_tasks');
}
export function payCoupon() {
	return request.get('task/pay_coupon');
}

export function watchTv() {
	return request.get('task/watch_tv');
}
export function zhuanzeng(data){
	return request.post('user/zhuan_zeng',data)
}
export function fudouzhuan(data){
	return request.post('user/fudou_zhuan',data)
}
export function fubaozhuan(data){
	return request.post('user/fubao_zhuan',data)
}
export function getSxf(){
	return request.get('user/sxf');
}
export function getInfo(){
	return request.get('user/info')
}
export function getPayType() {
	return request.get('user/pay_type')
}
export function saveData(data) {
	return request.post('user/save_pay_type',data)
}
export function getOtcInfo(){
	return request.get('get_otc_zdj')
}
export function sendOtc(data){
	return request.post('send_otc',data)
}
export function getOtcList(data){
	return request.get('get_otc_list',data)
}
export function getMyOtcList(data){
	return request.get('get_my_otc_list',data)
}
export function otcOrderInfo(id){
	return request.get(`otc_order_info/${id}`)
}
export function maichuOtc(data){
	return request.post('sale_otc',data)
}
export function payOtc(id)
{
	return request.get(`pay_otc/${id}`)
}
export function savePayInfo(data){
	return request.post('save_pay_info',data)
}

export function okshoukuan(id){
	return request.get(`ok_shou_kuan/${id}`)
}
export function okOver(id){
	return request.get(`ok_over/${id}`)
}
export function cancel(id){
	return request.get(`cancel/${id}`)
}
export function xfqpay(id){
	return request.get(`xfq_pay/${id}`)
}
export function editQuyu(data){
	return request.post('edit_quyu',data)
}

export function suggest(data){
	return request.post('suggest', data)
}
export function lingqu(){
	return request.get('lingqu')
}
export function watchOver(data){
	return request.get('watch_over',data)
}
export function qianyue(data){
	return request.post('qian_yue',data)

}
export function okQianYue(data){
	return request.post('save_qian_yue',data)
