<template>
	<view>
		...
		<view class="box-bg px-3 mt-1">
			<view class="w-100 mt-1 swiper" style="height: 188px;">
			...
			<view class="mt-2 flex align-center bg-white rounded" style="height: 64rpx;" v-if="notes">
				<view class="flex align-center pl-1">
				<image src="/static/images/icon_notice@2x.png" style="width: 48rpx;height: 48rpx;" mode=""></image>
				<text class="my-font-text" style="font-size: 26rpx;color: #333;">公告</text>
				</view>
				 <view class="ml-2" style="width: 1px;height: 13px;background:#DDDDDD;"></view>
				<view class="flex-1 pl-2 notice" style="height: 50rpx;" @click="goNotice" >
					<!-- <uni-notice-bar style="height: 50rpx;" :speed="50" scrollable single background-color="#fff" color="#666666" :text="notes" :key="notes"></uni-notice-bar> -->
					 <marquee-notice :text="notes"></marquee-notice>
				</view>
			</view>
		</view>
