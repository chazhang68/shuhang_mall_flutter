  ...
  <view :style="colorStyle">
    <view class='productList'>
      ...
      <view class='nav acea-row row-middle'>
        ...
        <view class='item' @click='set_where(5)'>
          {{ title == '燃料商城' ? $t(`燃料值`) : '' }}
          {{ title == '荣誉商城' ? $t(`荣誉值`) : ''}}
          <image v-if="qu==1" src='../../../static/images/up.png'></image>
          <image v-else-if="qu==2" src='../../../static/images/down.png'></image>
      ...
      <view class='list acea-row row-between-wrapper' :class='is_switch==true?"":"on"'>
        <view class='item' :class='is_switch==true?"":"on"' hover-class='none'
          ...
          <view class='text' :class='is_switch==true?"":"on"'>
            ...
            <view v-if="item.give_gxz > 0 " class="mt-1 flex p-1  align-center" >
            	<image src="/static/index-image/z.png" style="width: 24rpx;height: 24rpx;"></image>
            	<view class="ml-1" style="font-size: 10px;color: #FA281D;">{{item.give_gxz}}燃料值</view>
            </view>
            <view v-if="item.give_ryz > 0 " class="mt-1 flex p-1  align-center" >
            	<image src="/static/index-image/z.png" style="width: 24rpx;height: 24rpx;"></image>
            	<view class="ml-1" style="font-size: 10px;color: #FA281D;">{{item.give_ryz}}荣誉值</view>
            </view>
            <view class='money font-color flex justify-between' :class='is_switch==true?"":"on"'>
              <view>
                {{ $t(`￥`) }}<text class='num'>{{ item.price }}</text>
              </view>
              <view>
...
export default {
  ...
  methods: {
    ...
    set_where: function (e) {
      switch (e) {
		...
		case 5:
		    ...
		    else if (this.qu == 1) this.qu = 2;
		    else if (this.qu == 2) this.qu = 0;
		    this.price = 0
			this.stock = 0
		    break;
      }
    ...
    setWhere: function () {
	  ...
	  if (this.qu == 0) this.where.salesOrder = '';
	  else if (this.qu == 1) this.where.qutype = 'asc';
	  else if (this.qu == 2) this.where.qutype = 'desc';
