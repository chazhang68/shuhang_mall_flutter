				...
				<scroll-view :scroll-top="scrollTop" scroll-y="true" scroll-with-animation="true"
					...
					<view id="past0">
						...
						<view class="wrapper">
							<view class="share acea-row row-between row-bottom">
								<view class="money font-color" style="font-size: 16px;">
									消费券
                      ...
                      storeInfo.is_vip == 1 &&
					  svip_price_open == 1
                    ">{{$t(`消费券`)}}{{ storeInfo.vip_price }}</text>
									<image v-if="
                      storeInfo.vip_price &&
                      storeInfo.vip_price > 0 &&
                      storeInfo.is_vip == 1 &&
                    ...
                    " src="../../static/images/svip.gif"></image>
							...
							<view class="label acea-row row-between-wrapper" style="padding-bottom: 20rpx">
								<view class="" v-if="storeInfo.give_integral > 0">
									{{$t(`送消费券`)}} : {{storeInfo.give_integral || 0}}
								</view>
                ...
                " class="svip acea-row row-between-wrapper">
							...
							<!-- <view class='coupon acea-row row-between-wrapper' v-if="storeInfo.give_integral > 0">
									<view class='hide line1 acea-row'>
										赠消费券：
										<view class='activity'>赠送 {{storeInfo.give_integral}} 消费券</view>
									</view>
								</view> -->
