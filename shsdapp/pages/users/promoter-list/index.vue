	...
	<view :style="colorStyle">
		<view class="promoter-list">
			<view class='promoterHeader m-2'>
				<view class='headerCon acea-row row-between-wrapper align-center' style="height: 100%;">
					<view>
		...
		<view style="width: 100%;height: 50px;;position: fixed;bottom: 0px;left:0px;right:0px;background:#fff;display: flex;align-items: center;justify-content: center;border-top:1px solid #e6e6e6;" @click="dd()">
			<image src="/static/images/code.png" mode="widthFix" style="width: 30px;"></image>
			<view style="padding-left: 10rpx;">邀请码</view>
		</view>
	</view>
</template>
