...
<!--          <view class="input-pwd" style="margin-left: 80rpx">-->
<!--            <input type="password" focus placeholder="请输入原密码" v-model="old_password">-->
<!--          </view>-->
<!--        </template>-->
<!--        <template v-slot:rightTitle>-->
<!--          <uni-icons @click="clearOldPwd" style="margin-top: 1px" type="closeempty"></uni-icons>-->
<!--        </template>-->
<!--      </content-list>-->
      <content-list class="p-3 mt-2" :is-icon="false">
        ...
        <template v-slot:center>
          <view class="input-pwd">
            <uni-easyinput :placeholderStyle="inputStyle" :clearable="false" type="password" :input-border="false" v-model="new_password" placeholder="请输入新密码"></uni-easyinput>
          </view>
        </template>
      </content-list>
      ...
      <content-list style="margin-top: 1px" class="p-3" :is-icon="false">
        ...
        <template v-slot:center>
          <view class="input-pwd">
            <uni-easyinput :placeholderStyle="inputStyle" :clearable="false" type="password" :input-border="false" v-model="enter_password" placeholder="请再次输入新密码"></uni-easyinput>
          </view>
        </template>
      </content-list>
...
export default {
  ...
  methods: {
    ...
    editPwd: function (e) {
      ...
      // if (!old_password) return that.$util.Tips({
      //   title: that.$t(`请输入原密码`)
      // });
